...
// pandas_internal_is_NA is generated by Cython from pandas._libs.internal_na and MUST be linked to every compilation unit compiled from source code that includes this header (khash_python.h)
extern int pandas_internal_is_NA(PyObject *o);
...
static inline int pyobject_cmp(PyObject *a, PyObject *b) {
  ...
  if (Py_TYPE(a) == Py_TYPE(b)) {
    ...
    return 0;
  } else if (pandas_internal_is_NA(a) || pandas_internal_is_NA(b)) {
